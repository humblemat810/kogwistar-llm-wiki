...
JOB_KIND_INTENTS: dict[str, MaintenanceIntent] = {
    ...
    "document_reparse_region": MaintenanceIntent.SPLIT_NODE,
    ...
    "entity_disambiguation_scan": MaintenanceIntent.REQUEST_REVIEW,
    "entity_disambiguation_reconcile": MaintenanceIntent.REQUEST_REVIEW,
    "entity_disambiguation_review": MaintenanceIntent.REQUEST_REVIEW,
    "entity_disambiguation_patch_proposal": MaintenanceIntent.REQUEST_REVIEW,
