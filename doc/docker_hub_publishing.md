...
example, `pyproject.toml` version `0.3.9` is published as `v0.3.9`; do not
...
```powershell
docker login
.\scripts\publish_docker_images.ps1 -Tag v0.3.9
```
...
```powershell
.\scripts\publish_docker_images.ps1 -Tag v0.3.9 -Target embedding-cpu
.\scripts\publish_docker_images.ps1 -Tag v0.3.9 -Target embedding-cuda12.8
.\scripts\publish_docker_images.ps1 -Tag v0.3.9 -Target all
```
