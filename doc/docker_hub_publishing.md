...
example, `pyproject.toml` version `0.4.1` is published as `v0.4.1`; do not
...
```powershell
docker login
.\scripts\publish_docker_images.ps1 -Tag v0.4.1
```
...
```powershell
.\scripts\publish_docker_images.ps1 -Tag v0.4.1 -Target embedding-cpu
.\scripts\publish_docker_images.ps1 -Tag v0.4.1 -Target embedding-cuda12.8
.\scripts\publish_docker_images.ps1 -Tag v0.4.1 -Target all
```
