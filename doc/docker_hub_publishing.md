...
example, `pyproject.toml` version `0.3.6` is published as `v0.3.6`; do not
...
```powershell
docker login
.\scripts\publish_docker_images.ps1 -Tag v0.3.6
```
...
```powershell
.\scripts\publish_docker_images.ps1 -Tag v0.3.6 -Target embedding-cpu
.\scripts\publish_docker_images.ps1 -Tag v0.3.6 -Target embedding-cuda12.8
.\scripts\publish_docker_images.ps1 -Tag v0.3.6 -Target all
```
