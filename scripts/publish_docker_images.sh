...
Examples:
  ./scripts/publish_docker_images.sh --docker-hub-user profchan --tag v0.3.9
  ./scripts/publish_docker_images.sh --target embedding-cuda12.8 --tag v0.3.9
  ./scripts/publish_docker_images.sh --target all --tag v0.3.9
EOF
}
